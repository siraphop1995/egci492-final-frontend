  ...
  <v-container>
      ...
      <v-flex xs12 sm3 class="ml-1">
        <v-card>
          <v-layout column align-center>
            ...
            <v-flex>
              <EditProfile />
              <!-- <v-btn small fab dark class="teal">
                <v-icon>edit</v-icon>
              </v-btn>-->
              ...
              >
                <template v-slot:activator>
                  <v-list-tile>
                    ...
                    <v-list-tile-action >  
                        <v-icon small color="light-blue darken-4" @click="editAlbumName=true">edit</v-icon>
                    </v-list-tile-action>
                    <v-list-tile-action>
    ...
    <v-dialog max-width="410px" v-model="editAlbumName">
      <v-card>
        ...
        <v-card-text>
          <v-form>
            <v-text-field label="New Name" :rules="requiredRules" color="orange"></v-text-field>
          </v-form>
        </v-card-text>
        <v-btn flat dark class="mx-0 mt-3" id="gold">OK</v-btn>
